 ...
 */
public final class NcDispatcherDecoderV2 {

    private static final byte[] MAGIC = new byte[] { 0x72, 0x71, (byte) 0x89 };
    private static final int MAX_STR = 300;

    private NcDispatcherDecoderV2() {
    }

    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: NcDispatcherDecoderV2 <raw-http-file> <client-home>");
            System.exit(2);
        }
    ...
    private static boolean isSensitiveProperty(String name) {
        return "getUserId".equals(name) || "getUserCode".equals(name) || "getCallId".equals(name);
    }
